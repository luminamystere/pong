...
export default class Ball {
    ...
    ballPos;
    ballVelocity = this.getDefaultBallVelocity();
    get ballRectangle() {
    ...
    lastOnTop;
    ballPhysicsUpdate(width, height, pong) {
    ...
    getDefaultBallPosition(width, height) {
        return new Vector2(Math.ceil(width / 2), Math.ceil(height));
    }
    getDefaultBallVelocity() {
